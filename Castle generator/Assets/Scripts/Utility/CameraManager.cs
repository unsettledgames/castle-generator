...
public class CameraManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float destinationPosX = transform.position.x + (xInput * smoothFactor * Time.deltaTime);
        float destinationPosY = transform.position.y + (yInput * smoothFactor * Time.deltaTime);
